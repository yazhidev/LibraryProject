package com.yazhi1992.yazhilib.imagePicker;
...
import com.yazhi1992.yazhilib.imagePicker.bean.ImageItem;
import com.yazhi1992.yazhilib.imagePicker.loader.ImageFolder;
import com.yazhi1992.yazhilib.imagePicker.loader.ImageLoader;
import com.yazhi1992.yazhilib.imagePicker.view.CropImageView;
import com.yazhi1992.yazhilib.utils.LibProviderUtil;
        ...
        if (takePictureIntent.resolveActivity(activity.getPackageManager()) != null) {
            ...
            if (takeImageFile != null) {
                ...
                if (VERSION.SDK_INT <= VERSION_CODES.M) {
                     ...
                     */
                    uri = FileProvider.getUriForFile(activity, LibProviderUtil.getFileProviderName(activity), takeImageFile);
                    //加入uri权限 要不三星手机不能拍照
                ...
                Log.e("nanchen", LibProviderUtil.getFileProviderName(activity));
