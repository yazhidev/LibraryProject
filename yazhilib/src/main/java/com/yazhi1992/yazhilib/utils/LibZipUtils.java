...
/**
 * Created by zengyazhi on 2017/8/11.
 */
...
public class LibZipUtils {
    ...
    public static String getFileType(String filename, String defaultType) {
        ...
        if(LibUtils.isNullOrEmpty(fileType)) {
            fileType = defaultType;
            LibUtils.myLog("使用默认文件类型");
        }
        return fileType;
    }
     ...
     *
     * @param zipFileString ZIP的名称
     * @param outName       压缩后文件的名称
     * @throws Exception
     */
    public static void UnZipWithOutName(String zipFileString, String outName) throws Exception {
        ZipInputStream inZip = new ZipInputStream(new FileInputStream(zipFileString));
        ZipEntry zipEntry;
        String szName = "";
        while ((zipEntry = inZip.getNextEntry()) != null) {
